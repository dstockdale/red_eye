...
const otherData = [
  { time: "2018-10-11", value: 11.89 },
  { time: "2018-10-12", value: 12.65 },
  { time: "2018-10-13", value: 10.56 },
  { time: "2018-10-14", value: 44.19 },
  { time: "2018-10-15", value: 33.86 },
  { time: "2018-10-16", value: 12.25 },
];
  ...
  useEffect(() => {
    ...
    if (started) {
      const interval = setInterval(() => {
        ...
        const nextArea = {
          time: time,
          value: 53 - 15 * Math.random(),
        };
        const nextLine = {
          time: time,
          value: 19 - 10 * Math.random(),
        };
        series1.current.update(nextArea);
        series2.current.update(nextLine);
      }, 1000);
